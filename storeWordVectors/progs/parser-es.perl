...
# CircR: [VERB<lemma:ser|estar>] [ADJ|CONJ<coord:adj>] [PRP] VERB<mode:N> [NOUNCOORD|PRO<type:D|P|I|X>]? PRP NOUNCOORD|PRO<type:D|P|I|X>
# NEXT
# DobjR: [VERB<lemma:ser|estar>] [ADJ|CONJ<coord:adj>] [PRP] VERB<mode:N> NOUNCOORD|PRO<type:D|P|I|X> [PRP]? [NOUNCOORD|PRO<type:D|P|I|X>]?
# NEXT
# CprepR: [VERB<lemma:ser|estar>] ADJ|CONJ<coord:adj> PRP VERB<mode:N> [NOUNCOORD|PRO<type:D|P|I|X>]? [PRP]? [NOUNCOORD|PRO<type:D|P|I|X>]?
(@temp) = ($listTags =~ /(?:$VERB${l}lemma:(?:ser|estar)\|${r})(?:$ADJ$a|$CONJ${l}coord:adj\|${r})(?:$PRP$a)($VERB${l}mode:N\|${r})(?:$NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})?($PRP$a)($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "CircR";
HeadRelDep($Rel,"",@temp);
(@temp) = ($listTags =~ /(?:$VERB${l}lemma:(?:ser|estar)\|${r})(?:$ADJ$a|$CONJ${l}coord:adj\|${r})(?:$PRP$a)($VERB${l}mode:N\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})(?:$PRP$a)?(?:$NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})?/g);
$Rel =  "DobjR";
...
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($VERB${l}lemma:(?:ser|estar)\|${r})($ADJ$a|$CONJ${l}coord:adj\|${r})($PRP$a)($VERB${l}mode:N\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})?($PRP$a)?($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})?/$1$2/g;

# AdjnR: NOUN [VERB<lemma:ser>] NOUNCOORD|PRO<type:D|P|I|X>
# NEXT
# AtrR: [NOUN] VERB<lemma:ser> NOUNCOORD|PRO<type:D|P|I|X>
# NEXT
# SubjL: NOUN VERB<lemma:ser> [NOUNCOORD|PRO<type:D|P|I|X>]
(@temp) = ($listTags =~ /($NOUN$a)(?:$VERB${l}lemma:ser\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "AdjnR";
HeadDep($Rel,"",@temp);
(@temp) = ($listTags =~ /(?:$NOUN$a)($VERB${l}lemma:ser\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})/g);
$Rel =  "AtrR";
...
$Rel =  "SubjL";
DepHead($Rel,"",@temp);
$listTags =~ s/($NOUN$a)($VERB${l}lemma:ser\|${r})($NOUNCOORD|$PRO${l}type:(?:D|P|I|X)\|${r})/$2/g;

# AdjnR: NOUN [VERB<lemma:ser|estar>] ADJ|CONJ<coord:adj>
# NEXT
# AtrR: [NOUN] VERB<lemma:ser|estar> ADJ|CONJ<coord:adj>
# NEXT
# SubjL: NOUN VERB<lemma:ser|estar> [ADJ|CONJ<coord:adj>]
(@temp) = ($listTags =~ /($NOUN$a)(?:$VERB${l}lemma:(?:ser|estar)\|${r})($ADJ$a|$CONJ${l}coord:adj\|${r})/g);
$Rel =  "AdjnR";
HeadDep($Rel,"",@temp);
(@temp) = ($listTags =~ /(?:$NOUN$a)($VERB${l}lemma:(?:ser|estar)\|${r})($ADJ$a|$CONJ${l}coord:adj\|${r})/g);
$Rel =  "AtrR";
...
$Rel =  "SubjL";
DepHead($Rel,"",@temp);
$listTags =~ s/($NOUN$a)($VERB${l}lemma:(?:ser|estar)\|${r})($ADJ$a|$CONJ${l}coord:adj\|${r})/$2/g;

# AtrR: VERB<lemma:ser|estar> ADJ|CONJ<coord:adj>
(@temp) = ($listTags =~ /($VERB${l}lemma:(?:ser|estar)\|${r})($ADJ$a|$CONJ${l}coord:adj\|${r})/g);
$Rel =  "AtrR";
HeadDep($Rel,"",@temp);
$listTags =~ s/($VERB${l}lemma:(?:ser|estar)\|${r})($ADJ$a|$CONJ${l}coord:adj\|${r})/$1/g;
