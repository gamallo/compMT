...
###########################BEGIN GRAMMAR#############################################
				{#<function>
					...
					# Single: [X<lemma:this>] X<lemma:january|february|march|april|may|june|july|august|september|october|november|december>
					# Corr: tag:DATE
					@temp = ($listTags =~ /(?:$X${l}lemma:this\|${r})($X${l}lemma:(?:january|february|march|april|may|june|july|august|september|october|november|december)\|${r})/g);
					$Rel =  "Single";
					Head($Rel,"",\@temp);
					$listTags =~ s/($X${l}lemma:this\|${r})($X${l}lemma:(?:january|february|march|april|may|june|july|august|september|october|november|december)\|${r})/$1$2/g;
					Corr("Head","tag:DATE",\@temp);

					# Single: [VERB] X<lemma:as>
					# Corr: tag:PRP
					@temp = ($listTags =~ /(?:$VERB$a2)($X${l}lemma:as\|${r})/g);
					$Rel =  "Single";
					Head($Rel,"",\@temp);
					$listTags =~ s/($VERB$a2)($X${l}lemma:as\|${r})/$1$2/g;
					Corr("Head","tag:PRP",\@temp);
...
{#<function>
					...
					# DobjR: VERB VERB<mode:[GN]>
					@temp = ($listTags =~ /($VERB$a2)($VERB${l}mode:[GN]\|${r})/g);
					$Rel =  "DobjR";
					HeadDep($Rel,"",\@temp);
					$listTags =~ s/($VERB$a2)($VERB${l}mode:[GN]\|${r})/$1/g;
